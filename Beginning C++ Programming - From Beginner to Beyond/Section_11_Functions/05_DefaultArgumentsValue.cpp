/*
---------Section 11 -  Default Arguments ----------------
    - When a func is called, all args must be supllied
    - Sometimes some of the args have the same values most of the time
    - We can tell the compiler to use default values if the args not supllied
    ...
    - Can have multiple default values
        -must appear consecutively at the tail end of the parameter list - повинні з’являтися послідовно в кінці списку параметрів
*/
