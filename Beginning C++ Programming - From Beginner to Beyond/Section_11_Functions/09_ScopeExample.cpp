/*
---------Section 11 - Scope example ----------------
Scope rules:
    - C++ uses scope rules to determine where an indentifier can be used
    - C++ uses static or lexical scoping
    - Local or Block scope
    - Global scope

Local or Block scope:
    - Indetifiers declared in a block {}
    - Function parameters have block scope
    - Only visible within the block{} where ther declared
    ...
    - With nested blocks can 'see' but outer blocks cannot 'see' in
